...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    """
    efficienty_level = ((voltage * current) / theoretical_max_power) * 100
    if efficienty_level >= 80:
        return "green"
    elif 60 <= efficienty_level < 80:
        return "orange"
    elif 30 <= efficienty_level < 60:
        return "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    min_threshold = .9 * threshold
    max_threshold = 1.1 * threshold
    if (temperature * neutrons_produced_per_second) < min_threshold:
        return "LOW"
    elif (temperature * neutrons_produced_per_second) > max_threshold:
        return "DANGER"
    else:
        return "NORMAL"
